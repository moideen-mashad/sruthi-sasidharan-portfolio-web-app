...
const About = () => {
  ...
  return (
    <div className="about_bg py-20 lg:py-32" id="aboutMe">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap items-center max-w-7xl mx-auto">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            <h2 className="sub_title mb-4 text-3xl sm:text-4xl font-bold tracking-tight">About Me</h2>
            <h3 className="category_title mb-3 font-semibold text-xl opacity-90 border-l-4 border-black pl-4 py-1">
              {userData.job_role}
            </h3>
            <div className="para text-base sm:text-lg leading-relaxed opacity-80 space-y-4 max-w-xl">
              <p>{userData.about}</p>
            </div>
          </div>
        </div>
